...
function User() {
    ...
    useEffect(() => {
        ...
        const getUserAndReposData = async () => {
            const result = await getUserAndRepos(params.login)
            // console.log(result)

            dispatch({type: 'SET_USER_AND_REPOS', payload: result})
        }
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 mb-8 md:gap-8">
                    <div className="custom-card-image mb-6 md:mb-0">
                        <div className="rounded-lg shadow-xl card image-full">
                            ...
                            <div className="card-body items-start" style={{marginTop: "8rem"}}>
                    ...
                    <div className="col-span-2">
                        ...
                        <div className="w-full rounded-lg shadow-md bg-base-300 stats">
                            ...
                            {twitter_username && (<div className="stat">
                                <div className="stat-title text-md"><h1>X (Twitter)</h1></div>
                                <div className="text-lg stat-value">
